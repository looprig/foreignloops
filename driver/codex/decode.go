...
func decodeLine(line []byte) ([]driver.Event, error) {
	...
	case eventTurnCompleted:
		return []driver.Event{{Kind: driver.KindTerminalOK}}, nil
...
func decodeCompletedItem(raw json.RawMessage) ([]driver.Event, error) {
	if len(raw) == 0 {
		return nil, nil
	}
	...
	return []driver.Event{{Kind: driver.KindStepComplete, Message: msg}}, nil
}
